...
--resource_name CE_UO --role_name ROLE --end_date_name END_DATE --pred_column independent_activity --predict_activities "Back-Office Adjustment Requested" \
--experiment_name prova_activity_BAC_BOC --explain True
